...
twitter_pattern = re.compile(r'(https?://[a-zA-Z0-9\-\.]*twitter\.com/[^\s"\']+|https?://[a-zA-Z0-9\-\.]*x\.com/[^\s"\']+)')
whatsapp_pattern = re.compile(r'(https?://[a-zA-Z0-9\-\.]*whatsapp\.com/[^\s"\']+|https?://wa\.me/\d+)')

# Pages to scrape
PAGES = [
    "/", "/contact", "/contact-us", "/get-in-touch", "/reach-us", "/connect", "/contact-form",
    "/contact.html", "/contact-us.html", "/get-in-touch.html", "/reach-us.html", "/connect.html", "/contact-form.html",
    "/about", "/about-us", "/who-we-are", "/our-story", "/company", "/organization",
    "/about.html", "/about-us.html", "/who-we-are.html", "/our-story.html", "/company.html", "/organization.html",
    "/team", "/our-team", "/staff", "/doctors", "/management", "/leadership",
    "/team.html", "/our-team.html", "/staff.html", "/doctors.html", "/management.html", "/leadership.html",
    "/locations", "/branches", "/offices", "/clinics", "/find-us", "/where-we-are",
    "/locations.html", "/branches.html", "/offices.html", "/clinics.html", "/find-us.html", "/where-we-are.html",
    "/support", "/help", "/faq", "/customer-care", "/assistance", "/contact-support", "/enquiry",
    "/support.html", "/help.html", "/faq.html", "/customer-care.html", "/assistance.html", "/contact-support.html", "/enquiry.html",
    "/privacy", "/privacy-policy", "/terms", "/terms-of-service", "/legal", "/disclaimer",
    "/privacy.html", "/privacy-policy.html", "/terms.html", "/terms-of-service.html", "/legal.html", "/disclaimer.html"
]
...
async def scrape_site_async(base_url, session):
    results = {k: set() for k in ["email","facebook","instagram","linkedin","twitter","whatsapp"]}
    ...
    if pages_content and pages_content[0]:
        ...
        extra_tasks = [fetch(session, link) for link in extra_links[:SCRAPER_SETTINGS["limit_depth"]]]  # limit depth
...
async def scrape_with_playwright(url):
    ...
    try:
        async with async_playwright() as p:
            ...
            await page.goto(url, timeout=SCRAPER_SETTINGS["playwright_timeout"])  # longer timeout for slow servers
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for idx, row in df.iterrows():
            ...
            if not url or not isinstance(url, str) or not url.strip():
                results[idx] = {k: None for k in ["email","facebook","instagram","linkedin","twitter","whatsapp"]}
                continue
